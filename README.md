...
helm registry login harbor.7kgroup.org

# Install Minecraft
helm install minecraft oci://harbor.7kgroup.org/7kminato/charts/minecraft \
  --namespace minato \
  --create-namespace
...
```bash
# Tenant A
helm install minecraft-tenant-a oci://harbor.7kgroup.org/7kminato/charts/minecraft \
  --namespace tenant-a \
  --create-namespace \
...
# Tenant B
helm install minecraft-tenant-b oci://harbor.7kgroup.org/7kminato/charts/minecraft \
  --namespace tenant-b \
  --create-namespace \
  --set fleet.enabled=true \
